...
The repository also includes `test_hard.py`, implementing four rigorous internal boundary Pytest validations:
* `test_deseq2_runs_successfully`
* `test_input_validation_empty`
* `test_input_validation_matching_names`
* `test_input_validation_non_negative`
